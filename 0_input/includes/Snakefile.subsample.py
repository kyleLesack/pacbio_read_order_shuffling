...
# Dictionaries used to specify how much subsampling is needed to obtain the desired depth after alignment
NGMLRDICT10X = {"N2": "0.13","XZ1516": "0.13"}
MINIMAPDICT10X = {"N2": "0.12","XZ1516": "0.12"}
PBMMDICT10X = {"N2": "0.12","XZ1516": "0.13"}
NGMLRDICT20X = {"N2": "0.26", "XZ1516": "0.27"}
MINIMAPDICT20X = {"N2": "0.24", "XZ1516": "0.23"}
PBMMDICT20X = {"N2": "0.25", "XZ1516": "0.26"}
NGMLRDICT40X = {"N2": "0.52", "XZ1516": "0.54"}
MINIMAPDICT40X = {"N2": "0.48", "XZ1516": "0.47"}
PBMMDICT40X = {"N2": "0.50", "XZ1516": "0.51"}
NGMLRDICT60X = {"N2": "0.78", "XZ1516": "0.81"}
MINIMAPDICT60X = {"N2": "0.72", "XZ1516": "0.70"}
PBMMDICT60X = {"N2": "0.75", "XZ1516": "0.77"}
...
rule subsample_ngmlr_10X:
	...
	resources:
		...
		time_hms="01:00:00"
	shell:
		"""seqtk sample {input} {params.value} > {output}"""
...
rule shuffle_subsampled:
	...
	output:
		"1_fq_processing/subsampled/{aligner}/{depth}/{strain}/shuffled/{strain}_shuffled.fastq"
	resources:
